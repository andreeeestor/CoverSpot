        ...
        <section class="text-gray-600 body-font">
          <div class="container px-5 py-24 mx-auto">
            <div class="flex flex-col text-center w-full mb-20">
              <h1 class="sm:text-5xl text-4xl lg:text-balance font-semibold text-pretty mb-6 tracking-tight text-gray-900">
                Nossa Equipe
              </h1>
              <ul class="lg:w-2/3 mx-auto leading-relaxed text-base text-start">
