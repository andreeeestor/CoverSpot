...
const ListaBandasPage = () => {
  ...
  const handleOpenChat = (band) => {
    ...
    const chatId = `chat_${userId}_${band.id}`;
    setSelectedChat({
      chatId,
      recipientName: band.nomeCover,
      recipientId: band.id
    });
    setIsChatOpen(true);
  };
    ...
    const fetchBands = async () => {
      try {
        const response = await axios.get(
          "http://localhost:3000/api/bandas-cover"
        );
  ...
  return (
    <>
      <Sidebar />
      <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100 py-12 px-4 sm:px-6 lg:px-8 pl-10">
